...
<body class="bg-background-light dark:bg-background-dark text-slate-900 dark:text-white overflow-x-hidden">
    <header
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <a class="hidden sm:flex items-center justify-center h-9 px-4 rounded-lg bg-primary hover:bg-blue-700 text-white text-sm font-bold transition-colors shadow-sm"
                    href="#pricing">
                    Daftar Sekarang
                </a>
            </div>
    ...
    <section class="pt-32 pb-16 lg:pt-40 lg:pb-24 px-4 overflow-hidden relative">
        <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-2">
                    ...
                    <div class="flex items-center gap-2 px-4 py-2">
                        <div class="flex -space-x-2">
                            <img alt="Mentee 1" class="size-8 rounded-full border-2 border-white dark:border-slate-900"
                                data-alt="Portrait of a smiling young student"
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuCeQjKvmcb79fbMwSodwtm0l7icxdy9otFDsPt_5gQXWf4kbQtEFRbmy9MhnOdnziN0eOGbcq2myK_8BuSfP5s7Jt3kxZvJvdQHf3OTk0zf-J3KfxlPYUFWk59ocL1JW7mO8SVQ_Gif_YfW7nm1jMbzu0wSG23773hH34y6g3U_tzFJ1g3aV7PkERCSd62dGjScuqszPH1yag2glZprE28wcIiE0b38HSZDWH-GQUP4RZ6rSwR5f7CyFIydHi11ce_YcZHBlMHUCV4" />
                            <img alt="Mentee 2" class="size-8 rounded-full border-2 border-white dark:border-slate-900"
                                data-alt="Portrait of a male student"
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBVmRphQRel45_3Y6sNtcrHNbTXxkPt-8ZktW5cP-Anel8FtsAZFbbzn_RJS8Ev9hvdkBuDZzRcW9hVfbSOHT65oQe0ARhsr8TYALuOLSDfjyH_wtOWATUWWkMfEB1ORLV55h_iL2QBUtFIO5fewmt-owUijTC6U8xa4RSIzxnfQ67sHaVagZKsDr9bOLpqpijsZ82zRcgi0FEoiLsBxZla4R4jTNod6CgdvorvBiEubR57WtP2nYiaaAmv9cWdSH7kVFnb_s4u5Po" />
                            <img alt="Mentee 3" class="size-8 rounded-full border-2 border-white dark:border-slate-900"
                                data-alt="Portrait of a female student"
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAdH3sJsSc60JEz5UhQXy_TKrjrDMBRyVNajOzto3l32gdlUQ-fgPtpicZZQp5aJXQU_Tp4a2o101tPNZ9d4CqQYXXuKLG5y9T68tbQZwNk6ZkBBaNzptsIVv9Gok6RKn6_LIzF9R9Xlvf1xGd8oZzPe7-4SdvjGOIJAqOnsefAnByRqawVpHi6Lop9gsGv3bvy6hpZv2NedJ5U2bYPKKDCda48Pjfx8tz7YYl6EF78DrqCBXkq7dwHJPvmspgEaMVx4LuZ05kWR8Q" />
                        </div>
            ...
            <div
                class="relative lg:h-auto h-[300px] w-full rounded-2xl overflow-hidden shadow-2xl ring-1 ring-gray-900/5 group">
                <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent z-10"></div>
                <img alt="Students studying together"
                    class="object-cover w-full h-full transform transition-transform duration-700 group-hover:scale-105"
                    data-alt="Students studying on a university campus"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDV_Gj0ryrA2vFe94EM4Ar6YQX-Vrc0_UCrzWtL2-4Lk4DI_jPelkaMHGH5-ZkUVqGruioXiN_3OTAShd035ZG8fmGXI4lHLrY0Vgm-PvYOLuwx2Qcl7apqEgwhXjuNiPmASRU23bM1dnI9pBwXmXPgl54maI7C9eTTN3LGVbevQpUk4z9Q8MXvMgECNEAxV4b5zmwW-z_L7WVzHn62BPAVz90csbap2GuHEczA6r2Q7yFEfB5z1M0VZp0QJbp_kJ_H-6CsH_o4DDU" />
                <div
                    class="absolute bottom-6 left-6 z-20 bg-white/95 dark:bg-slate-800/95 backdrop-blur px-4 py-3 rounded-xl shadow-lg border border-white/20 max-w-[280px]">
                    <div class="flex items-start gap-3">
                        <div class="p-2 bg-green-100 rounded-lg text-green-600">
                            <span class="material-symbols-outlined">check_circle</span>
                        </div>
                        <div>
                            <p class="text-sm font-bold text-slate-900 dark:text-white">Lolos Administrasi</p>
                            <p class="text-xs text-slate-600 dark:text-slate-300 mt-1">"Essay review Hanchin sangat
                                membantu struktur tulisan saya!"</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-20 bg-white dark:bg-[#151b2b]" id="problem">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-3xl font-bold text-slate-900 dark:text-white mb-4">Kenapa Banyak Aplikasi Gagal?</h2>
                <p class="text-slate-600 dark:text-slate-300 text-lg">Jangan biarkan kesalahan umum menghambat impianmu
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div
                    class="bg-background-light dark:bg-background-dark p-8 rounded-2xl border border-gray-100 dark:border-gray-800 hover:shadow-xl transition-shadow group">
                    <div
                        class="w-12 h-12 rounded-xl bg-orange-100 text-orange-600 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                        <span class="material-symbols-outlined">search_off</span>
                    </div>
                    <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-3">Kurang Riset</h3>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="order-2 lg:order-1 relative">
                    ...
                    <div
                        class="bg-white dark:bg-[#151b2b] p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800 relative z-10">
    ...
    <section class="py-24 bg-white dark:bg-[#151b2b]" id="pricing">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <span class="text-primary font-bold tracking-wider uppercase text-sm">Pilihan Paket</span>
                <h2 class="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mt-2">Investasi Masa Depanmu
                </h2>
            </div>
            <div class="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto items-start">
                ...
                <div
                    ...
                    <div
                        class="absolute top-4 right-4 bg-accent text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider shadow-sm">
                        Recommended
                    </div>
    ...
    <section class="py-16 bg-white dark:bg-[#151b2b] border-t border-b border-gray-100 dark:border-gray-800">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="flex flex-col items-center gap-6">
                <div class="size-14 rounded-full bg-green-100 text-green-600 flex items-center justify-center mb-2">
                ...
                <a class="inline-flex items-center justify-center h-12 px-8 rounded-full bg-green-500 hover:bg-green-600 text-white font-bold transition-all shadow-lg hover:shadow-green-500/30 gap-2 mt-2"
                    ...
                    <span class="text-white fill-current">
                        <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M12.012 2c-5.506 0-9.989 4.478-9.993 9.985a9.96 9.96 0 0 0 1.503 5.31L2.2 22l4.839-1.267a9.99 9.99 0 0 0 4.973 1.325h.004c5.505 0 9.988-4.48 9.992-9.985.003-2.668-1.033-5.176-2.919-7.065C17.206 3.036 14.686 2 12.012 2zM12.017 20.31a8.305 8.305 0 0 1-4.246-1.163l-.304-.18-3.155.827.842-3.076-.197-.314a8.3 8.3 0 0 1-1.272-4.418c.003-4.572 3.727-8.293 8.303-8.293 2.217.002 4.3.864 5.866 2.428a8.256 8.256 0 0 1 2.434 5.856c-.004 4.573-3.728 8.293-8.271 8.333zM16.56 14.86c-.248-.124-1.467-.723-1.694-.806-.228-.083-.394-.124-.559.124-.165.248-.642.806-.786.971-.145.165-.29.186-.537.062-1.606-.798-2.661-2.226-3.05-3.666-.037-.14.12-.22.28-.362l.228-.27c.108-.145.215-.29.322-.486.066-.124.033-.238-.017-.34-.05-.104-.446-1.075-.611-1.472-.161-.384-.326-.331-.446-.337l-.38-.006c-.132 0-.347.05-.529.248-.182.198-.694.678-.694 1.654 0 .976.711 1.918.81 2.051.099.133 1.398 2.134 3.386 2.993 1.339.578 1.612.463 1.9.434.463-.047 1.467-.6 1.674-1.178.206-.579.206-1.075.145-1.178-.062-.104-.227-.166-.475-.29z">
                            </path>
                        </svg>
                    </span>
    ...
    <section class="py-20 bg-blue-900 relative overflow-hidden" id="bonus">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <span
                ...
                Time Bonus</span>
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-8">Daftar Hari Ini &amp; Dapatkan Toolkit Eksklusif
            </h2>
            <div
                class="grid sm:grid-cols-2 gap-4 text-left bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-2xl">
                <div class="flex items-center gap-4">
                    <div class="size-10 rounded bg-white/20 flex items-center justify-center text-accent">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-blue-200">Template excel untuk tracking progress.</p>
                    </div>
                </div>
            </div>
            <div class="mt-10">
    ...
    <footer class="bg-background-light dark:bg-[#0b0f17] border-t border-gray-200 dark:border-gray-800 pt-16 pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-8 mb-12">
                ...
                <div>
                    <h5 class="font-bold text-slate-900 dark:text-white mb-4">Program</h5>
                    <ul class="space-y-2 text-sm text-slate-500 dark:text-slate-400">
                        <li><a class="hover:text-primary" href="#">GKS-G Mentoring</a></li>
                        <li><a class="hover:text-primary" href="#">GKS-U Mentoring</a></li>
                        <li><a class="hover:text-primary" href="#">Webinar Series</a></li>
                    </ul>
                </div>
                <div>
            ...
            <div
                ...
                <p class="text-sm text-slate-500 dark:text-slate-500">© 2023 Hanchin Mentoring. All rights reserved.</p>
